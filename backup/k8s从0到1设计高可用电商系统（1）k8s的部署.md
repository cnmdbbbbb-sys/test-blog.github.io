...
<img width="955" height="277" alt="Image" src="https://github.com/user-attachments/assets/bcb68919-1372-4357-a3af-eee020c8837f" />

CoreDNS 是 Pending 状态：这是正常的。因为 K8s 的 DNS 服务依赖于网络插件（CNI），在网络插件准备好之前，DNS 无法工作。